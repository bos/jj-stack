...
pull request and review branch remain until you close your pull request and run cleanup:

```console
jj-stack cleanup --pull-request <pr> --close
```

For a whole stack, follow [Close or separate pull requests](close-or-separate.md).
